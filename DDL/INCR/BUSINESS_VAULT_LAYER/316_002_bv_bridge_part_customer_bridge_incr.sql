CREATE OR REPLACE FUNCTION "moto_scn01_proc"."bv_bridge_part_customer_bridge_incr"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- bridge_tgt
	...
	(
		SELECT 
			  1 AS "dummy"
		FROM "moto_scn01_bv"."bridge_part_customer" "bridge_src"
		WHERE  "bridge_src"."bridge_part_customer_hkey" = "miv"."bridge_part_customer_hkey"
	)
	;
END;
