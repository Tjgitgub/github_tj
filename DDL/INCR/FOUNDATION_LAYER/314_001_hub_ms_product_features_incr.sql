CREATE OR REPLACE FUNCTION "moto_scn01_proc"."hub_ms_product_features_incr"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- hub_tgt
	...
	LEFT OUTER JOIN "moto_scn01_fl"."hub_product_features" "hub_src" ON  "min_load_time"."product_features_hkey" = "hub_src"."product_features_hkey"
	WHERE  "min_load_time"."dummy" = 1 AND "hub_src"."product_features_hkey" is NULL
	;
END;
