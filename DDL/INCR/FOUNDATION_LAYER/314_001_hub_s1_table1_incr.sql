CREATE OR REPLACE FUNCTION "project1_proc"."hub_s1_table1_incr"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- hub_tgt
	...
	LEFT OUTER JOIN "dv_0114_fl"."hub_table1" "hub_src" ON  "min_load_time"."table1_hkey" = "hub_src"."table1_hkey"
	WHERE  "min_load_time"."dummy" = 1 AND "hub_src"."table1_hkey" is NULL
	;
END;
