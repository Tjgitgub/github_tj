CREATE OR REPLACE FUNCTION "moto_scn01_proc"."lks_ms_inli_part_incr"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- lks_temp_tgt
	...
	TRUNCATE TABLE "moto_sales_scn01_stg"."lks_ms_inli_part_tmp"  CASCADE;

	INSERT INTO "moto_sales_scn01_stg"."lks_ms_inli_part_tmp"(
		 "lnk_inli_part_hkey"
		,"parts_hkey"
		,"invoice_lines_hkey"
		,"load_date"
	...
	( 
		SELECT 
			...
			, MIN("stg_dis_src"."error_code_inli_part") AS "error_code_inli_part"
		FROM "moto_sales_scn01_stg"."invoice_lines" "stg_dis_src"
		WHERE  "stg_dis_src"."error_code_inli_part" in(0,1)
	...
	( 
		SELECT 
			...
			, MIN("dist_stg"."error_code_inli_part") AS "error_code_inli_part"
		FROM "moto_scn01_fl"."lks_ms_inli_part" "last_lks_src"
		INNER JOIN "moto_scn01_fl"."lnk_inli_part" "last_lnk_src" ON  "last_lks_src"."lnk_inli_part_hkey" = "last_lnk_src"."lnk_inli_part_hkey"
	...
	( 
		SELECT 
			  "stg_temp_src"."lnk_inli_part_hkey" AS "lnk_inli_part_hkey"
		...
		WHERE  "stg_temp_src"."error_code_inli_part" in(0,1)
		UNION 
		SELECT 
			  "lks_src"."lnk_inli_part_hkey" AS "lnk_inli_part_hkey"
			, "lnk_src"."parts_hkey" AS "parts_hkey"
			...
			, "lks_src"."part_id" AS "part_id"
		FROM "moto_scn01_fl"."lks_ms_inli_part" "lks_src"
		INNER JOIN "moto_scn01_fl"."lnk_inli_part" "lnk_src" ON  "lks_src"."lnk_inli_part_hkey" = "lnk_src"."lnk_inli_part_hkey"
		INNER JOIN "last_lks" "last_lks" ON  "lnk_src"."invoice_lines_hkey" = "last_lks"."invoice_lines_hkey"
		WHERE  "lks_src"."load_end_date" = TO_TIMESTAMP('31/12/2399 23:59:59.000000' , 'DD/MM/YYYY HH24:MI:SS.US'::varchar) OR("last_lks"."error_code_inli_part" = 0 AND "lks_src"."load_date" >= "last_lks"."max_load_timestamp")
	)
	SELECT 
		  "temp_table_set"."lnk_inli_part_hkey" AS "lnk_inli_part_hkey"
		...
		, CASE WHEN "temp_table_set"."source" = 'STG' AND "temp_table_set"."delete_flag"::text || "temp_table_set"."parts_hkey"::text =
			LAG( "temp_table_set"."delete_flag"::text || "temp_table_set"."parts_hkey"::text,1)OVER(PARTITION BY "temp_table_set"."invoice_lines_hkey" ORDER BY "temp_table_set"."load_date","temp_table_set"."origin_id")THEN 1 ELSE 0 END AS "equal"
...
BEGIN -- lks_inur_tgt
	...
	INSERT INTO "moto_scn01_fl"."lks_ms_inli_part"(
		 "lnk_inli_part_hkey"
		,"parts_hkey"
		,"invoice_lines_hkey"
		,"load_date"
	...
	SELECT 
		  "lks_temp_src_inur"."lnk_inli_part_hkey" AS "lnk_inli_part_hkey"
		, "lks_temp_src_inur"."parts_hkey" AS "parts_hkey"
		...
		, "lks_temp_src_inur"."part_id" AS "part_id"
	FROM "moto_sales_scn01_stg"."lks_ms_inli_part_tmp" "lks_temp_src_inur"
...
BEGIN -- lks_ed_tgt
	...
	( 
		SELECT 
			  "lks_temp_src_us"."lnk_inli_part_hkey" AS "lnk_inli_part_hkey"
		...
		FROM "moto_sales_scn01_stg"."lks_ms_inli_part_tmp" "lks_temp_src_us"
	...
	( 
		SELECT 
			  "calc_load_end_date"."lnk_inli_part_hkey" AS "lnk_inli_part_hkey"
	...
	UPDATE "moto_scn01_fl"."lks_ms_inli_part" "lks_ed_tgt"
	SET 
	...
	WHERE "lks_ed_tgt"."lnk_inli_part_hkey" =  "filter_load_end_date"."lnk_inli_part_hkey"
