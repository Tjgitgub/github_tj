CREATE OR REPLACE FUNCTION "moto_scn01_proc"."sat_ms_part_incr"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- sat_temp_tgt
	...
	TRUNCATE TABLE "moto_sales_scn01_stg"."sat_ms_parts_tmp"  CASCADE;

	INSERT INTO "moto_sales_scn01_stg"."sat_ms_parts_tmp"(
		 "parts_hkey"
		,"load_date"
		,"load_end_date"
		,"load_cycle_id"
	...
	( 
		SELECT DISTINCT 
 			  "stg_dis_src"."parts_hkey" AS "parts_hkey"
			, "stg_dis_src"."load_cycle_id" AS "load_cycle_id"
		FROM "moto_sales_scn01_stg"."parts" "stg_dis_src"
	...
	( 
		SELECT 
			...
			, "stg_temp_src"."ref_part_number_fk" AS "ref_part_number_fk"
			, "stg_temp_src"."ref_part_language_code_fk" AS "ref_part_language_code_fk"
			, "stg_temp_src"."part_number" AS "part_number"
			, "stg_temp_src"."part_language_code" AS "part_language_code"
			, "stg_temp_src"."update_timestamp" AS "update_timestamp"
		FROM "moto_sales_scn01_stg"."parts" "stg_temp_src"
		...
		SELECT 
			...
			, "sat_src"."ref_part_number_fk" AS "ref_part_number_fk"
			, "sat_src"."ref_part_language_code_fk" AS "ref_part_language_code_fk"
			, "sat_src"."part_number" AS "part_number"
			, "sat_src"."part_language_code" AS "part_language_code"
			, "sat_src"."update_timestamp" AS "update_timestamp"
		FROM "moto_scn01_fl"."sat_ms_parts" "sat_src"
		INNER JOIN "dist_stg" "dist_stg" ON  "sat_src"."parts_hkey" = "dist_stg"."parts_hkey"
	...
	SELECT 
		...
		, CASE WHEN "temp_table_set"."source" = 'STG' AND "temp_table_set"."delete_flag"::text || "temp_table_set"."hash_diff"::text =
			LAG( "temp_table_set"."delete_flag"::text || "temp_table_set"."hash_diff"::text,1)OVER(PARTITION BY "temp_table_set"."parts_hkey" ORDER BY "temp_table_set"."load_date","temp_table_set"."origin_id")THEN 1 ELSE 0 END AS "equal"
		...
		, "temp_table_set"."ref_part_number_fk" AS "ref_part_number_fk"
		, "temp_table_set"."ref_part_language_code_fk" AS "ref_part_language_code_fk"
		, "temp_table_set"."part_number" AS "part_number"
		, "temp_table_set"."part_language_code" AS "part_language_code"
...
BEGIN -- sat_inur_tgt
	...
	SELECT 
		  "sat_temp_src_inur"."parts_hkey" AS "parts_hkey"
		...
		, "sat_temp_src_inur"."part_id" AS "part_id"
		, "sat_temp_src_inur"."ref_part_number_fk" AS "ref_part_number_fk"
		, "sat_temp_src_inur"."ref_part_language_code_fk" AS "ref_part_language_code_fk"
		, "sat_temp_src_inur"."part_number" AS "part_number"
		, "sat_temp_src_inur"."part_language_code" AS "part_language_code"
		, "sat_temp_src_inur"."update_timestamp" AS "update_timestamp"
	FROM "moto_sales_scn01_stg"."sat_ms_parts_tmp" "sat_temp_src_inur"
...
BEGIN -- sat_ed_tgt
	...
	( 
		SELECT 
			  "sat_temp_src_us"."parts_hkey" AS "parts_hkey"
			, "sat_temp_src_us"."load_date" AS "load_date"
			, "lci_src"."load_cycle_id" AS "load_cycle_id"
			, COALESCE(LEAD("sat_temp_src_us"."load_date",1)OVER(PARTITION BY "sat_temp_src_us"."parts_hkey" ORDER BY "sat_temp_src_us"."load_date")
				, TO_TIMESTAMP('31/12/2399 23:59:59.000000', 'DD/MM/YYYY HH24:MI:SS.US'::varchar)) AS "load_end_date"
		FROM "moto_sales_scn01_stg"."sat_ms_parts_tmp" "sat_temp_src_us"
	...
	( 
		SELECT 
			  "calc_load_end_date"."parts_hkey" AS "parts_hkey"
	...
	UPDATE "moto_scn01_fl"."sat_ms_parts" "sat_ed_tgt"
	SET 
	...
	WHERE "sat_ed_tgt"."parts_hkey" =  "filter_load_end_date"."parts_hkey"
