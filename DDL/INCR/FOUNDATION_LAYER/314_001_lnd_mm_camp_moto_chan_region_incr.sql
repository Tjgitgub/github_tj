CREATE OR REPLACE FUNCTION "moto_scn01_proc"."lnd_mm_camp_moto_chan_region_incr"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- lnd_tgt
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "change_set"."lnd_camp_moto_chan_region_hkey" ORDER BY "change_set"."load_date",
	...
	LEFT OUTER JOIN "moto_scn01_fl"."lnd_camp_moto_chan_region" "lnd_src" ON  "min_load_time"."lnd_camp_moto_chan_region_hkey" = "lnd_src"."lnd_camp_moto_chan_region_hkey"
	WHERE  "lnd_src"."lnd_camp_moto_chan_region_hkey" IS NULL AND "min_load_time"."dummy" = 1
	;
END;
