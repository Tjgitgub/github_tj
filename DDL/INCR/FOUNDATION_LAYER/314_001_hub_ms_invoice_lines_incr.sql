CREATE OR REPLACE FUNCTION "moto_scn01_proc"."hub_ms_invoice_lines_incr"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- hub_tgt
	...
	LEFT OUTER JOIN "moto_scn01_fl"."hub_invoice_lines" "hub_src" ON  "min_load_time"."invoice_lines_hkey" = "hub_src"."invoice_lines_hkey"
	WHERE  "min_load_time"."dummy" = 1 AND "hub_src"."invoice_lines_hkey" is NULL
	;
END;
