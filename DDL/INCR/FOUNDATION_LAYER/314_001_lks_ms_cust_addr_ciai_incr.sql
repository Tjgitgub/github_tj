CREATE OR REPLACE FUNCTION "moto_scn01_proc"."lks_ms_cust_addr_ciai_incr"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- lks_temp_tgt
	...
	TRUNCATE TABLE "moto_sales_scn01_stg"."lks_ms_cust_addr_ciai_tmp"  CASCADE;

	INSERT INTO "moto_sales_scn01_stg"."lks_ms_cust_addr_ciai_tmp"(
	...
	( 
		SELECT 
			...
			, MIN("stg_dis_src"."error_code_cust_addr_ciai") AS "error_code_cust_addr_ciai"
		FROM "moto_sales_scn01_stg"."customers" "stg_dis_src"
		WHERE  "stg_dis_src"."error_code_cust_addr_ciai" in(0,1)
	...
	( 
		SELECT 
			...
			, MIN("dist_stg"."error_code_cust_addr_ciai") AS "error_code_cust_addr_ciai"
		FROM "moto_scn01_fl"."lks_ms_cust_addr_ciai" "last_lks_src"
		INNER JOIN "moto_scn01_fl"."lnk_cust_addr_ciai" "last_lnk_src" ON  "last_lks_src"."lnk_cust_addr_ciai_hkey" = "last_lnk_src"."lnk_cust_addr_ciai_hkey"
	...
	( 
		SELECT 
			  "stg_temp_src"."lnk_cust_addr_ciai_hkey" AS "lnk_cust_addr_ciai_hkey"
			, "stg_temp_src"."addresses_ciai_hkey" AS "addresses_ciai_hkey"
			...
			, "stg_temp_src"."customer_invoice_address_id" AS "customer_invoice_address_id"
		FROM "moto_sales_scn01_stg"."customers" "stg_temp_src"
		WHERE  "stg_temp_src"."error_code_cust_addr_ciai" in(0,1)
		UNION 
		SELECT 
			  "lks_src"."lnk_cust_addr_ciai_hkey" AS "lnk_cust_addr_ciai_hkey"
			, "lnk_src"."addresses_ciai_hkey" AS "addresses_ciai_hkey"
			...
			, "lks_src"."customer_invoice_address_id" AS "customer_invoice_address_id"
		FROM "moto_scn01_fl"."lks_ms_cust_addr_ciai" "lks_src"
		INNER JOIN "moto_scn01_fl"."lnk_cust_addr_ciai" "lnk_src" ON  "lks_src"."lnk_cust_addr_ciai_hkey" = "lnk_src"."lnk_cust_addr_ciai_hkey"
		INNER JOIN "last_lks" "last_lks" ON  "lnk_src"."customers_hkey" = "last_lks"."customers_hkey"
		WHERE  "lks_src"."load_end_date" = TO_TIMESTAMP('31/12/2399 23:59:59.000000' , 'DD/MM/YYYY HH24:MI:SS.US'::varchar) OR("last_lks"."error_code_cust_addr_ciai" = 0 AND "lks_src"."load_date" >= "last_lks"."max_load_timestamp")
	)
	SELECT 
		  "temp_table_set"."lnk_cust_addr_ciai_hkey" AS "lnk_cust_addr_ciai_hkey"
		, "temp_table_set"."addresses_ciai_hkey" AS "addresses_ciai_hkey"
		...
		, CASE WHEN "temp_table_set"."source" = 'STG' AND "temp_table_set"."delete_flag"::text || "temp_table_set"."addresses_ciai_hkey"::text =
			LAG( "temp_table_set"."delete_flag"::text || "temp_table_set"."addresses_ciai_hkey"::text,1)OVER(PARTITION BY "temp_table_set"."customers_hkey" ORDER BY "temp_table_set"."load_date","temp_table_set"."origin_id")THEN 1 ELSE 0 END AS "equal"
		, "temp_table_set"."delete_flag" AS "delete_flag"
		, "temp_table_set"."trans_timestamp" AS "trans_timestamp"
		, "temp_table_set"."customer_number" AS "customer_number"
		, "temp_table_set"."customer_invoice_address_id" AS "customer_invoice_address_id"
...
BEGIN -- lks_inur_tgt
	...
	SELECT 
		  "lks_temp_src_inur"."lnk_cust_addr_ciai_hkey" AS "lnk_cust_addr_ciai_hkey"
		, "lks_temp_src_inur"."addresses_ciai_hkey" AS "addresses_ciai_hkey"
		...
		, "lks_temp_src_inur"."customer_invoice_address_id" AS "customer_invoice_address_id"
	FROM "moto_sales_scn01_stg"."lks_ms_cust_addr_ciai_tmp" "lks_temp_src_inur"
...
BEGIN -- lks_ed_tgt
	...
	( 
		SELECT 
			  "lks_temp_src_us"."lnk_cust_addr_ciai_hkey" AS "lnk_cust_addr_ciai_hkey"
		...
		FROM "moto_sales_scn01_stg"."lks_ms_cust_addr_ciai_tmp" "lks_temp_src_us"
	...
	( 
		SELECT 
			  "calc_load_end_date"."lnk_cust_addr_ciai_hkey" AS "lnk_cust_addr_ciai_hkey"
	...
	UPDATE "moto_scn01_fl"."lks_ms_cust_addr_ciai" "lks_ed_tgt"
	SET 
	...
	WHERE "lks_ed_tgt"."lnk_cust_addr_ciai_hkey" =  "filter_load_end_date"."lnk_cust_addr_ciai_hkey"
