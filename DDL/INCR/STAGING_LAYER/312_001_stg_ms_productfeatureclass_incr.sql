CREATE OR REPLACE FUNCTION "moto_scn01_proc"."stg_ms_productfeatureclass_incr"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- stg_tgt
	...
	SELECT 
		...
		, "calc_hash_keys"."pro_fea_cla_code_bk" AS "pro_fea_cla_code_bk"
		, "calc_hash_keys"."product_feature_class_desc" AS "product_feature_class_desc"
