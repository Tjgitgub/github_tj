CREATE OR REPLACE FUNCTION "moto_scn01_proc"."stg_ms_invoices_incr"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- stg_tgt
	...
	SELECT 
		...
		, "calc_hash_keys"."lnk_invo_cust_hkey" AS "lnk_invo_cust_hkey"
		...
		, "calc_hash_keys"."invoice_customer_id" AS "invoice_customer_id"
		, "calc_hash_keys"."invoice_number_bk" AS "invoice_number_bk"
		, "calc_hash_keys"."national_person_id_fk_invoicecustomerid_bk" AS "national_person_id_fk_invoicecustomerid_bk"
		, "calc_hash_keys"."invoice_date" AS "invoice_date"
		, "calc_hash_keys"."amount" AS "amount"
		, "calc_hash_keys"."discount" AS "discount"
		, "calc_hash_keys"."update_timestamp" AS "update_timestamp"
		, "calc_hash_keys"."error_code_invo_cust" AS "error_code_invo_cust"
...
BEGIN -- ext_err_tgt
	...
	WHERE ( "stg_err_src"."error_code_invo_cust" IN(1,3))AND "stg_err_src"."load_cycle_id" >= 0
	;
END;
