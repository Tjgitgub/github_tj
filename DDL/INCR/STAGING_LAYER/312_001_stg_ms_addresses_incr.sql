CREATE OR REPLACE FUNCTION "moto_scn01_proc"."stg_ms_addresses_incr"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- stg_tgt
	...
	TRUNCATE TABLE "moto_sales_scn01_stg"."addresses"  CASCADE;

	INSERT INTO "moto_sales_scn01_stg"."addresses"(
		 "addresses_hkey"
		,"load_date"
		,"load_cycle_id"
		,"trans_timestamp"
	...
	( 
		...
		FROM "moto_sales_scn01_ext"."addresses" "ext_src"
	...
	SELECT 
		...
		, "calc_hash_keys"."coordinates" AS "coordinates"
