CREATE OR REPLACE FUNCTION "moto_scn01_proc"."stg_mm_emails_incr"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- stg_tgt
	...
	TRUNCATE TABLE "moto_mktg_scn01_stg"."e_mails"  CASCADE;

	INSERT INTO "moto_mktg_scn01_stg"."e_mails"(
		 "contacts_hkey"
		,"load_date"
		,"load_cycle_id"
		,"trans_timestamp"
	...
	( 
		...
		FROM "moto_mktg_scn01_ext"."e_mails" "ext_src"
