CREATE OR REPLACE FUNCTION "moto_scn01_proc"."stg_mm_channels_incr"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- stg_tgt
	...
	SELECT 
		...
		, "calc_hash_keys"."channel_code_bk" AS "channel_code_bk"
		, "calc_hash_keys"."channel_description" AS "channel_description"
