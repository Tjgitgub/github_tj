...
DROP VIEW IF EXISTS "moto_scn01_bv"."lks_ms_invo_cust";
CREATE  VIEW "moto_scn01_bv"."lks_ms_invo_cust"  AS 
	SELECT 
		  "dvt_src"."lnk_invo_cust_hkey" AS "lnk_invo_cust_hkey"
	...
	FROM "moto_scn01_fl"."lks_ms_invo_cust" "dvt_src"
	;
