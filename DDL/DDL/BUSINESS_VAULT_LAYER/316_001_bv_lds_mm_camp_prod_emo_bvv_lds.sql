...
DROP VIEW IF EXISTS "moto_scn01_bv"."lds_mm_camp_prod_emo";
CREATE  VIEW "moto_scn01_bv"."lds_mm_camp_prod_emo"  AS 
	SELECT 
	...
	FROM "moto_scn01_fl"."lds_mm_camp_prod_emo" "dvt_src"
	;
