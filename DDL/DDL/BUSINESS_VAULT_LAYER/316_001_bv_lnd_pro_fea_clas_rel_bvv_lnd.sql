...
DROP VIEW IF EXISTS "moto_scn01_bv"."lnd_pro_fea_clas_rel";
CREATE  VIEW "moto_scn01_bv"."lnd_pro_fea_clas_rel"  AS 
	SELECT 
	...
	FROM "moto_scn01_fl"."lnd_pro_fea_clas_rel" "dvt_src"
	;
