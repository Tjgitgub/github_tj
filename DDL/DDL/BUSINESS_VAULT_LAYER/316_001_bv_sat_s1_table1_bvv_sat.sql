...
DROP VIEW IF EXISTS "dv_0114_bv"."sat_s1_table1";
CREATE  VIEW "dv_0114_bv"."sat_s1_table1"  AS 
	SELECT 
		  "dvt_src"."table1_hkey" AS "table1_hkey"
		, "dvt_src"."load_date" AS "load_date"
		, "dvt_src"."load_cycle_id" AS "load_cycle_id"
		, "dvt_src"."load_end_date" AS "load_end_date"
		, "dvt_src"."hash_diff" AS "hash_diff"
		, "dvt_src"."delete_flag" AS "delete_flag"
		, "dvt_src"."other_attr" AS "other_attr"
		, "dvt_src"."table1_id" AS "table1_id"
		, "dvt_src"."some_attr" AS "some_attr"
	FROM "dv_0114_fl"."sat_s1_table1" "dvt_src"
	;
