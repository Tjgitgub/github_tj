...
DROP VIEW IF EXISTS "moto_scn01_bv"."lks_ms_cust_addr_iats";
CREATE  VIEW "moto_scn01_bv"."lks_ms_cust_addr_iats"  AS 
	SELECT 
		  "dvt_src"."lnk_cust_addr_iats_hkey" AS "lnk_cust_addr_iats_hkey"
		, "dvt_src"."addresses_iats_hkey" AS "addresses_iats_hkey"
	...
	FROM "moto_scn01_fl"."lks_ms_cust_addr_iats" "dvt_src"
	;
