...
DROP VIEW IF EXISTS "moto_scn01_bv"."lds_mm_camp_moto_chan_region";
CREATE  VIEW "moto_scn01_bv"."lds_mm_camp_moto_chan_region"  AS 
	SELECT 
	...
	FROM "moto_scn01_fl"."lds_mm_camp_moto_chan_region" "dvt_src"
	;
