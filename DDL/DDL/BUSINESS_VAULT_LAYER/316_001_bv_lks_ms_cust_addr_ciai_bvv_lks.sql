...
DROP VIEW IF EXISTS "moto_scn01_bv"."lks_ms_cust_addr_ciai";
CREATE  VIEW "moto_scn01_bv"."lks_ms_cust_addr_ciai"  AS 
	SELECT 
		  "dvt_src"."lnk_cust_addr_ciai_hkey" AS "lnk_cust_addr_ciai_hkey"
	...
	FROM "moto_scn01_fl"."lks_ms_cust_addr_ciai" "dvt_src"
	;
