...
DROP VIEW IF EXISTS "moto_scn01_bv"."lnd_camp_moto_channel";
CREATE  VIEW "moto_scn01_bv"."lnd_camp_moto_channel"  AS 
	SELECT 
	...
	FROM "moto_scn01_fl"."lnd_camp_moto_channel" "dvt_src"
	;
