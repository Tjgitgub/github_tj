...
DROP VIEW IF EXISTS "moto_scn01_bv"."sat_ms_prod_featu_class";
CREATE  VIEW "moto_scn01_bv"."sat_ms_prod_featu_class"  AS 
	SELECT 
	...
	FROM "moto_scn01_fl"."sat_ms_prod_featu_class" "dvt_src"
	;
