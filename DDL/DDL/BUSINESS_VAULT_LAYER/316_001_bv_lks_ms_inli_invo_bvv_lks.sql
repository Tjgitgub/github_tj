...
DROP VIEW IF EXISTS "moto_scn01_bv"."lks_ms_inli_invo";
CREATE  VIEW "moto_scn01_bv"."lks_ms_inli_invo"  AS 
	SELECT 
		  "dvt_src"."lnk_inli_invo_hkey" AS "lnk_inli_invo_hkey"
	...
	FROM "moto_scn01_fl"."lks_ms_inli_invo" "dvt_src"
	;
