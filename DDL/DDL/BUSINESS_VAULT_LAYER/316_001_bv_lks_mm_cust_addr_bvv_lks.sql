...
DROP VIEW IF EXISTS "moto_scn01_bv"."lks_mm_cust_addr";
CREATE  VIEW "moto_scn01_bv"."lks_mm_cust_addr"  AS 
	SELECT 
		  "dvt_src"."lnk_cust_addr_hkey" AS "lnk_cust_addr_hkey"
	...
	FROM "moto_scn01_fl"."lks_mm_cust_addr" "dvt_src"
	;
