...
DROP VIEW IF EXISTS "moto_scn01_bv"."lks_mm_cust_cust_parentpartynumber";
CREATE  VIEW "moto_scn01_bv"."lks_mm_cust_cust_parentpartynumber"  AS 
	SELECT 
	...
	FROM "moto_scn01_fl"."lks_mm_cust_cust_parentpartynumber" "dvt_src"
	;
