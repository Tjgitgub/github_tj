...
DROP VIEW IF EXISTS "moto_scn01_bv"."sat_ms_customers_birth";
CREATE  VIEW "moto_scn01_bv"."sat_ms_customers_birth"  AS 
	SELECT 
	...
	FROM "moto_scn01_fl"."sat_ms_customers_birth" "dvt_src"
	;
