...
DROP VIEW IF EXISTS "moto_scn01_bv"."sat_mm_phones";
CREATE  VIEW "moto_scn01_bv"."sat_mm_phones"  AS 
	SELECT 
		...
		, "dvt_src"."phone_number" AS "phone_number"
		, "dvt_src"."update_timestamp" AS "update_timestamp"
	FROM "moto_scn01_fl"."sat_mm_phones" "dvt_src"
	;
