...
DROP VIEW IF EXISTS "dv_0114_bv"."sat_s1_table3";
CREATE  VIEW "dv_0114_bv"."sat_s1_table3"  AS 
	SELECT 
		...
		, "dvt_src"."table3_id" AS "table3_id"
		, "dvt_src"."some_attr" AS "some_attr"
		, "dvt_src"."other_attr" AS "other_attr"
	FROM "dv_0114_fl"."sat_s1_table3" "dvt_src"
	;
