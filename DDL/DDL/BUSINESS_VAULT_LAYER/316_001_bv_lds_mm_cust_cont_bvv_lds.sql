...
DROP VIEW IF EXISTS "moto_scn01_bv"."lds_mm_cust_cont";
CREATE  VIEW "moto_scn01_bv"."lds_mm_cust_cont"  AS 
	SELECT 
		  "dvt_src"."lnd_cust_cont_hkey" AS "lnd_cust_cont_hkey"
	...
	FROM "moto_scn01_fl"."lds_mm_cust_cont" "dvt_src"
	;
