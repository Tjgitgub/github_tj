...
DROP VIEW IF EXISTS "moto_scn01_bv"."sat_ms_customers_name";
CREATE  VIEW "moto_scn01_bv"."sat_ms_customers_name"  AS 
	SELECT 
		...
		, "dvt_src"."first_name" AS "first_name"
		, "dvt_src"."last_name" AS "last_name"
		, "dvt_src"."gender" AS "gender"
		, "dvt_src"."update_timestamp" AS "update_timestamp"
	FROM "moto_scn01_fl"."sat_ms_customers_name" "dvt_src"
	;
