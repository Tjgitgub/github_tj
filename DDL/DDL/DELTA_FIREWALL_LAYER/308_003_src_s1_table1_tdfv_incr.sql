...
DROP VIEW IF EXISTS "source1_dfv"."vw_table1";
CREATE  VIEW "source1_dfv"."vw_table1"  AS 
	WITH "delta_view_filter" AS 
	( 
		SELECT 
			  'S' ::text AS "record_type"
			, "cdc_src"."other_attr" AS "other_attr"
			, "cdc_src"."table1_id" AS "table1_id"
			, "cdc_src"."some_attr" AS "some_attr"
		FROM "source1_cdc"."cdc_table1" "cdc_src"
	)
	, "delta_view" AS 
	( 
		SELECT 
			...
			, "delta_view_filter"."table1_id" AS "table1_id"
	...
	( 
		SELECT 
			...
			, COALESCE("delta_view"."other_attr","mex_bk_src"."key_attribute_varchar") AS "other_attr"
			, "delta_view"."table1_id" AS "table1_id"
	...
	SELECT 
		...
		, "prepjoinbk"."table1_id" AS "table1_id"
