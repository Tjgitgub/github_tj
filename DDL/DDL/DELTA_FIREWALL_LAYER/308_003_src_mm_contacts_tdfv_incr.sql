...
DROP VIEW IF EXISTS "moto_mktg_scn01_dfv"."vw_contacts";
CREATE  VIEW "moto_mktg_scn01_dfv"."vw_contacts"  AS 
	...
	( 
		...
		FROM "moto_mktg_scn01"."jrn_contacts" "cdc_src"
	...
	( 
		SELECT 
			...
			, "delta_view_filter"."contact_type" AS "contact_type"
			, "delta_view_filter"."contact_type_desc" AS "contact_type_desc"
		...
		SELECT 
			...
			, CASE WHEN("cdc_aft"."contact_type" = "cdc_bef"."contact_type")or("cdc_aft"."contact_type" IS NULL AND 
				"cdc_bef"."contact_type" IS NULL)THEN 'unchanged'::text else "cdc_aft"."contact_type" end AS "contact_type"
			, CASE WHEN("cdc_aft"."contact_type_desc" = "cdc_bef"."contact_type_desc")or("cdc_aft"."contact_type_desc" IS NULL AND 
				"cdc_bef"."contact_type_desc" IS NULL)THEN 'unchanged'::text else "cdc_aft"."contact_type_desc" end AS "contact_type_desc"
		...
		FROM "moto_mktg_scn01"."jrn_contacts" "cdc_aft"
		INNER JOIN "moto_mktg_scn01"."jrn_contacts" "cdc_bef" ON  "cdc_bef"."trans_id" = "cdc_aft"."trans_id"
		INNER JOIN "delta_window" "delta_window" ON  1 = 1
