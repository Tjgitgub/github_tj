...
DROP VIEW IF EXISTS "moto_sales_scn01_dfv"."vw_product_feature_cat";
CREATE  VIEW "moto_sales_scn01_dfv"."vw_product_feature_cat"  AS 
	...
	( 
		...
		FROM "moto_sales_scn01"."jrn_product_feature_cat" "cdc_src"
	...
	( 
		SELECT 
			...
			, "delta_view_filter"."product_feature_category_id" AS "product_feature_category_id"
			, "delta_view_filter"."product_feature_category_code" AS "product_feature_category_code"
			, "delta_view_filter"."prod_feat_cat_language_code" AS "prod_feat_cat_language_code"
			, "delta_view_filter"."prod_feat_cat_description" AS "prod_feat_cat_description"
