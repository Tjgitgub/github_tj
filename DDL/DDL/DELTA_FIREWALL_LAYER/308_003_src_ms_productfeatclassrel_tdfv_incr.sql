...
DROP VIEW IF EXISTS "moto_sales_scn01_dfv"."vw_product_feat_class_rel";
CREATE  VIEW "moto_sales_scn01_dfv"."vw_product_feat_class_rel"  AS 
	...
	( 
		...
		FROM "moto_sales_scn01"."jrn_product_feat_class_rel" "cdc_src"
