...
DROP VIEW IF EXISTS "moto_sales_scn01_dfv"."vw_addresses";
CREATE  VIEW "moto_sales_scn01_dfv"."vw_addresses"  AS 
	...
	( 
		SELECT 
			...
			, "cdc_src"."coordinates" AS "coordinates"
			, "cdc_src"."update_timestamp" AS "update_timestamp"
		FROM "moto_sales_scn01"."jrn_addresses" "cdc_src"
	...
	( 
		SELECT 
			...
			, "delta_view_filter"."coordinates" AS "coordinates"
	...
	( 
		SELECT 
			...
			, "delta_view"."coordinates" AS "coordinates"
	...
	SELECT 
		...
		, "prepjoinbk"."coordinates" AS "coordinates"
