...
DROP VIEW IF EXISTS "moto_mktg_scn01_dfv"."vw_e_mails";
CREATE  VIEW "moto_mktg_scn01_dfv"."vw_e_mails"  AS 
	...
	( 
		...
		FROM "moto_mktg_scn01"."jrn_e_mails" "cdc_src"
	...
	( 
		...
		FROM "moto_mktg_scn01"."jrn_e_mails" "cdc_aft"
		INNER JOIN "moto_mktg_scn01"."jrn_e_mails" "cdc_bef" ON  "cdc_bef"."trans_id" = "cdc_aft"."trans_id"
		INNER JOIN "delta_window" "delta_window" ON  1 = 1
