CREATE OR REPLACE FUNCTION "moto_scn01_proc"."lnd_mm_camp_prod_init"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- lnd_tgt
	...
	TRUNCATE TABLE "moto_scn01_fl"."lnd_camp_prod"  CASCADE;
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "change_set"."lnd_camp_prod_hkey" ORDER BY "change_set"."load_cycle_id",
