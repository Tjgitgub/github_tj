CREATE OR REPLACE FUNCTION "moto_scn01_proc"."lnk_ms_prse_prod_init"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- lnk_tgt
	...
	TRUNCATE TABLE "moto_scn01_fl"."lnk_prse_prod"  CASCADE;
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "change_set"."lnk_prse_prod_hkey" ORDER BY "change_set"."load_cycle_id",
