CREATE OR REPLACE FUNCTION "moto_scn01_proc"."lnk_ms_cust_addr_ciai_init"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- lnk_tgt
	...
	TRUNCATE TABLE "moto_scn01_fl"."lnk_cust_addr_ciai"  CASCADE;
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "change_set"."lnk_cust_addr_ciai_hkey" ORDER BY "change_set"."load_cycle_id",
