CREATE OR REPLACE FUNCTION "moto_scn01_proc"."lks_ms_inli_invo_init"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- lks_tgt
	...
	TRUNCATE TABLE "moto_scn01_fl"."lks_ms_inli_invo"  CASCADE;
	...
	( 
		SELECT 
			  "stg_inr_src"."lnk_inli_invo_hkey" AS "lnk_inli_invo_hkey"
	...
	SELECT 
		  "stg_src"."lnk_inli_invo_hkey" AS "lnk_inli_invo_hkey"
