CREATE OR REPLACE FUNCTION "moto_scn01_proc"."lks_mm_cust_addr_init"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- lks_tgt
	...
	TRUNCATE TABLE "moto_scn01_fl"."lks_mm_cust_addr"  CASCADE;
	...
	( 
		...
		WHERE  "stg_inr_src"."error_code_cust_addr" = 0
	)
	SELECT 
		  "stg_src"."lnk_cust_addr_hkey" AS "lnk_cust_addr_hkey"
