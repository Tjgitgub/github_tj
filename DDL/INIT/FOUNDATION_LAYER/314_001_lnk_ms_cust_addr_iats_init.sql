CREATE OR REPLACE FUNCTION "moto_scn01_proc"."lnk_ms_cust_addr_iats_init"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- lnk_tgt
	...
	TRUNCATE TABLE "moto_scn01_fl"."lnk_cust_addr_iats"  CASCADE;
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "change_set"."lnk_cust_addr_iats_hkey" ORDER BY "change_set"."load_cycle_id",
