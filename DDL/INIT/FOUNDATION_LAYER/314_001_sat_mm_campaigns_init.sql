CREATE OR REPLACE FUNCTION "moto_scn01_proc"."sat_mm_campaigns_init"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- sat_tgt
	...
	TRUNCATE TABLE "moto_scn01_fl"."sat_mm_campaigns"  CASCADE;
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "stg_inr_src"."campaigns_hkey" ORDER BY "stg_inr_src"."load_date") AS "dummy"
		FROM "moto_mktg_scn01_stg"."campaigns" "stg_inr_src"
	)
	SELECT 
		  "stg_src"."campaigns_hkey" AS "campaigns_hkey"
		...
		, "stg_src"."campaign_code" AS "campaign_code"
		, "stg_src"."campaign_start_date" AS "campaign_start_date"
		, "stg_src"."campaign_name" AS "campaign_name"
