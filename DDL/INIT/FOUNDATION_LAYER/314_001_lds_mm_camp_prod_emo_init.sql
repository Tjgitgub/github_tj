CREATE OR REPLACE FUNCTION "moto_scn01_proc"."lds_mm_camp_prod_emo_init"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- lds_tgt
	...
	TRUNCATE TABLE "moto_scn01_fl"."lds_mm_camp_prod_emo"  CASCADE;
	...
	SELECT 
		...
		, "stg_dl_src"."motorcycle_emotion_desc" AS "motorcycle_emotion_desc"
		, "stg_dl_src"."motorcycle_comment" AS "motorcycle_comment"
