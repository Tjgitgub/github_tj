CREATE OR REPLACE FUNCTION "project1_proc"."ext_s1_table2_init"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- ext_tgt
	...
	TRUNCATE TABLE "source1_ext"."table2"  CASCADE;

	INSERT INTO "source1_ext"."table2"(
		 "load_cycle_id"
		,"load_date"
		,"jrn_flag"
		,"record_type"
	...
	( 
		SELECT 
			...
			, COALESCE("ini_src"."table2_id", CAST("mex_inr_src"."key_attribute_integer" AS INTEGER)) AS "table2_id"
			, "ini_src"."some_attr" AS "some_attr"
			, "ini_src"."other_attr" AS "other_attr"
		FROM "source1_ini"."table2" "ini_src"
	...
	( 
		SELECT 
			...
			, "load_init_data"."table2_id" AS "table2_id"
		...
		SELECT 
			...
			, CAST("mex_ext_src"."key_attribute_integer" AS INTEGER) AS "table2_id"
	...
	( 
		SELECT 
			...
			, "prep_excep"."table2_id" AS "table2_id"
			, COALESCE(UPPER( "prep_excep"."table2_id"::text),"mex_src"."key_attribute_integer") AS "table2_id_bk"
	...
	SELECT 
		...
		, "calculate_bk"."table2_id" AS "table2_id"
		, "calculate_bk"."table2_id_bk" AS "table2_id_bk"
