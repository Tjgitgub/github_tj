CREATE OR REPLACE FUNCTION "moto_scn01_proc"."ext_mm_phones_init"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- ext_tgt
	...
	( 
		SELECT 
			...
			, "ini_src"."phone_number" AS "phone_number"
			, "ini_src"."update_timestamp" AS "update_timestamp"
		FROM "moto_mktg_scn01"."phones" "ini_src"
	...
	( 
		SELECT 
			...
			, "load_init_data"."phone_number" AS "phone_number"
		...
		SELECT 
			...
			, "mex_ext_src"."attribute_varchar"::text AS "phone_number"
	...
	( 
		SELECT 
			...
			, "prep_excep"."phone_number" AS "phone_number"
