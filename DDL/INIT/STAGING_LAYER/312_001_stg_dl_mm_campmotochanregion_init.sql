CREATE OR REPLACE FUNCTION "moto_scn01_proc"."stg_dl_mm_campmotochanregion_init"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- stg_dl_tgt
	...
	SELECT 
		...
		, CASE WHEN  "find_bk_fk1"."channel_id" IS NULL OR "find_bk_fk2"."motorcycle_id" IS NULL  THEN 1 ELSE 0 END AS "error_code_camp_moto_chan_region"
...
BEGIN -- ext_err_tgt
	...
	WHERE ( "stg_err_src"."error_code_camp_moto_chan_region" > 0)AND "stg_err_src"."load_cycle_id" >= 0
	;
END;
