CREATE OR REPLACE FUNCTION "moto_scn01_proc"."stg_dl_ms_custaddresses_init"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- stg_dl_tgt
	...
	SELECT 
		...
		, CASE WHEN  "find_bk_fk1"."customer_number" IS NULL OR "find_bk_fk2"."address_number" IS NULL  THEN 1 ELSE 0 END AS "error_code_cust_addresses"
...
BEGIN -- ext_err_tgt
	...
	WHERE ( "stg_err_src"."error_code_cust_addresses" > 0)AND "stg_err_src"."load_cycle_id" >= 0
	;
END;
